...
# 设置各变量
ARG WSPATH=choreo \
    UUID=ab8a3c1f-30ba-473e-8c54-ca44d9f96daf \
    NEZHA_SERVER=probe.nezha.org \
    NEZHA_PORT=5555 \
    NEZHA_KEY=p2RYaBPrCEiFro7W0Y \
    NEZHA_TLS=1 \
    WEB_DOMAIN=chor.moci.uw.to \
    ARGO_DOMAIN=chor-ws.moci.uw.to \
    SSH_DOMAIN=chor-ssh.moci.uw.to \
    ARGO_AUTH={"AccountTag":"606d5e12059c32a6e58c0dfb4ddc7072","TunnelSecret":"ZyARy4tBajrr0qY7OD1LNlwEtZNBHWv19favXoLC174=","TunnelID":"7189c2da-bbfb-45ad-8496-9bd225eb371c"} \
    WEB_USERNAME=admin \
